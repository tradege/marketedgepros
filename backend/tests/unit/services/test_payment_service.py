...
class TestPaymentServiceConfirmation:
    ...
    def test_confirm_payment_succeeded(self, mock_retrieve, mock_stripe_key, mock_challenge, session):
    ...
    @patch('stripe.PaymentIntent.retrieve')
    def test_confirm_payment_challenge_not_found(self, mock_retrieve, mock_stripe_key):
