        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://discord.gg/jKbmeSe7" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="Join our Discord">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/programs?type=one-phase" className="text-gray-400 hover:text-white transition-colors text-sm">
                  One Phase Challenge
                </a>
              </li>
              <li>
                <a href="/programs?type=two-phase" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Two Phase Challenge
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/risk-disclosure" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Risk Disclosure
                </Link>
              </li>
            </ul>
