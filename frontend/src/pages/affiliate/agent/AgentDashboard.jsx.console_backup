  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [dashboardResponse, commissionsResponse] = await Promise.all([
        api.get('/reports/affiliate/dashboard'),
        api.get('/commissions')
      ]);
      ...
      <div className="min-h-screen bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/affiliate/traders" className="text-primary-600 hover:text-primary-700 text-sm font-medium flex items-center gap-1">
                  View All
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/affiliate/commissions" className="text-primary-600 hover:text-primary-700 text-sm font-medium flex items-center gap-1">
                  View All
                  <ArrowUpRight className="w-4 h-4" />
                </Link>
              </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link to="/affiliate/traders" className="card hover:shadow-lg transition-shadow">
              <div className="flex items-center gap-3">
            ...
            <Link to="/affiliate/commissions" className="card hover:shadow-lg transition-shadow">
              <div className="flex items-center gap-3">
            ...
            <Link to="/affiliate/reports" className="card hover:shadow-lg transition-shadow">
              <div className="flex items-center gap-3">
