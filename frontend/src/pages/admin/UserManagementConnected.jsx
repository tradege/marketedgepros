...
function UserManagement() {
  ...
  const fetchHierarchy = async () => {
    try {
      setLoading(true);      const response = await api.get(
        `/users/hierarchy`
      );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-green-600 dark:text-green-400">Affiliates</p>
              <p className="text-2xl font-bold text-green-900 dark:text-green-100">
                {userCounts.affiliate}
              </p>
              <p className="text-xs text-green-600 dark:text-green-400 mt-1">Active affiliates</p>
            </div>
            ...
            <form onSubmit={handleAddUser} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-gray-400 mt-1">
                  Required for Master, Affiliate, and Trader roles
                </p>
              </div>
