          ...
          {challengeStats.map((stat, index) => {
            ...
            return (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-slate-800/70 transition-all duration-300">
                ...
                <p className={`text-4xl font-bold ${colorClasses[stat.color].text} mb-4`}>
                  {stat.value.toLocaleString()}
                </p>
                
                <div className="relative w-full h-2 bg-slate-700 rounded-full overflow-hidden">
                  <div
                    className={`absolute inset-y-0 left-0 ${colorClasses[stat.color].bg} rounded-full transition-all duration-500`}
